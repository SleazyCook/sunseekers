  ...
  return (
    <div>
      ...
      <p className="vallaki-laws">
        None shall speak Strahd’s name aloud or carry written documents bearing his name. Vallakovich believes that to speak his name is to summon his attention or presence. When they must, Vallakians refer to Strahd simply as “the Devil.”<br /><br />
        None may speak ill of the Baron or his festivals, nor hold any documents that present either in an ill light. The Baron believes that happiness is the key to the town’s safety, and severely punishes any resident that threatens to harm “morale.”<br /><br />
        All visitors and residents shall assist with the festivals. This includes both preparations and clean-up. These duties rotate through the general public on a random basis, in a manner similar to jury duty.<br /><br />
        All visitors and residents shall attend the festival. Guards routinely go door-to-door in the time before and during a festival, and patrol the streets to ensure that no attendee has been left out.<br /><br />
      ...
      <p className="vallaki-laws">
        Theft and “public brawling” are punished with 4d6 days of public humiliation in the stocks, with the length of the criminal’s stay depending on the severity and intent. Theft from the Baron’s estate, repeated minor offenses, or major injury to another civilian are punishable by exile from Vallaki to the wilderness of the Svalich Woods.<br /><br />
