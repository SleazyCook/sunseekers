  ...
  return (
    <div className="fuckity" onClick={()=>{setTransOpen(false)}}>
      ...
      <div className="tarroka__transcript">
        ...
        The light reveals a third illustration: a mysterious scowling figure grips the pommel of a sword pointed at the ground.  "The Seven of stars - the Hooded One". The crone's voice is strong with purpose. "I see a faceless god. He awaits you at the end of a long and winding road, deep in the mountains."<br /><br />
...
export default TarrokaTranscript