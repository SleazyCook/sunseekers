let tarrokaData = [
  // transmuter
  {
    ...
    card: "One of Stars",
    name: "Transmuter",
    cardFront: "https://i.imgur.com/i29osPB.png",
  ...
  // monk
  {
    ...
    card: "One of Glyphs",
    name: "Monk",
    cardFront: "https://i.imgur.com/jO6ak2e.png",
  ...
  // hooded one
  {
    ...
    update: "Umnos, Safzira, and Alina found a broken hilt within a dusty robe hidden away inside of a faceless statue in the Amber Temple",
    found: true,
    reward: "Sunsword",
